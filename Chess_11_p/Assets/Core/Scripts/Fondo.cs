...
public class Fondo : MonoBehaviour
{
    ...
    new Color(58f / 255f, 98f / 255f, 48f / 255f), // rgb(87, 185, 170)
    new Color(115f / 255f, 17f / 255f, 20f / 255f),  // rgb(115, 17, 20)
    new Color(165f / 255f, 92f / 255f, 198f / 255f)  // rgb(165, 92, 198)
};
    ...
    void GenerateGrid()
    {
        ...
        for (int row = 0; row < rows; row++)
        {
            for (int col = 0; col < columns; col++)
            {
                ...
                if ((row + col) % 2 == 0)
                {
                    img.color = new Color(229f / 255f, 225f / 255f, 215f / 255f); // Even sum -> white
                    originalColors[row, col] = new Color(229f / 255f, 225f / 255f, 215f / 255f); // Store the original color
                }
                else
                {
                    img.color = new Color(28f / 255f, 13f / 255f, 13f / 255f); // Odd sum -> black
                    originalColors[row, col] = new Color(28f / 255f, 13f / 255f, 13f / 255f); // Store the original color
                }
